 ...
 * Author: Ahmed Adel
 *
 * Created on February 27, 2023, 2:31 PM
 */
...
/* Select EUSART Mode (Asynchronous mode /Synchronous mode) */
#define EUSART_SYNCHRONOUS_MODE  		1
#define EUSART_ASYNCHRONOUS_MODE 		0
/* Baud rate Asynchronous mode speed (HIGH Speed / LOW Speed) */
#define EUSART_ASYNCHRONOUS_HIGH_SPEED  1
#define EUSART_ASYNCHRONOUS_LOW_SPEED  	0
/* Baud rate Asynchronous mode Register Size (16BIT / 8BIT) */
...
/* EUSART Receiver 9BIT Enable / Disable */
