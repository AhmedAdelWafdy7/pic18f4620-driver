...
# 2 "<built-in>" 2
# 1 "mca_layerl/ADC/hal_adc.c" 2
# 1 "mca_layerl/ADC/hal_adc.h" 1
# 13 "mca_layerl/ADC/hal_adc.h"
# 1 "mca_layerl/ADC/hal_adc_cfg.h" 1
# 13 "mca_layerl/ADC/hal_adc.h" 2
...
# 14 "mca_layerl/ADC/hal_adc.h" 2

# 1 "mca_layerl/ADC/../../mca_layerl/mcal_std_types.h" 1
# 11 "mca_layerl/ADC/../../mca_layerl/mcal_std_types.h"
# 1 "mca_layerl/ADC/../../mca_layerl/compiler.h" 1
# 10 "mca_layerl/ADC/../../mca_layerl/compiler.h"
...
# 10 "mca_layerl/ADC/../../mca_layerl/compiler.h" 2
# 11 "mca_layerl/ADC/../../mca_layerl/mcal_std_types.h" 2

# 1 "mca_layerl/ADC/../../mca_layerl/mcal_std_libraries.h" 1
# 10 "mca_layerl/ADC/../../mca_layerl/mcal_std_libraries.h"
...
# 10 "mca_layerl/ADC/../../mca_layerl/mcal_std_libraries.h" 2
# 12 "mca_layerl/ADC/../../mca_layerl/mcal_std_types.h" 2
# 31 "mca_layerl/ADC/../../mca_layerl/mcal_std_types.h"
typedef unsigned char uint8;
typedef unsigned short uint16;
typedef unsigned int uint32;
typedef uint8 STD_ReturnType;
# 15 "mca_layerl/ADC/hal_adc.h" 2

# 1 "mca_layerl/ADC/../interrupt/mcal_internal_interrupt.h" 1
# 13 "mca_layerl/ADC/../interrupt/mcal_internal_interrupt.h"
# 1 "mca_layerl/ADC/../interrupt/mcal_interrupt_config.h" 1
# 14 "mca_layerl/ADC/../interrupt/mcal_interrupt_config.h"
# 1 "mca_layerl/ADC/../interrupt/mcal_interrupt_gen_cfg.h" 1
# 14 "mca_layerl/ADC/../interrupt/mcal_interrupt_config.h" 2


# 1 "mca_layerl/ADC/../interrupt/../GPIO/hal_gpio.h" 1
# 14 "mca_layerl/ADC/../interrupt/../GPIO/hal_gpio.h"
# 1 "mca_layerl/ADC/../interrupt/../GPIO/../device_config.h" 1
...
# 14 "mca_layerl/ADC/../interrupt/../GPIO/hal_gpio.h" 2

# 1 "mca_layerl/ADC/../interrupt/../GPIO/hal_gpio_cfg.h" 1
# 15 "mca_layerl/ADC/../interrupt/../GPIO/hal_gpio.h" 2
# 31 "mca_layerl/ADC/../interrupt/../GPIO/hal_gpio.h"
typedef enum{
    low=0,
    high
}logic_t;
...
# 16 "mca_layerl/ADC/../interrupt/mcal_interrupt_config.h" 2
# 48 "mca_layerl/ADC/../interrupt/mcal_interrupt_config.h"
typedef enum{
    INERRUPT_LOW_PRIORITY=0,
    INERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 13 "mca_layerl/ADC/../interrupt/mcal_internal_interrupt.h" 2
# 16 "mca_layerl/ADC/hal_adc.h" 2
# 72 "mca_layerl/ADC/hal_adc.h"
...
static __attribute__((inline)) void adc_configure_voltage_refernce(const adc_conf_t *_adc);
...
STD_ReturnType ADC_GetConversionResult(const adc_conf_t *_adc,adc_result *conversion_result){
    ...
    if( (((void*)0) == _adc) || (((void*)0)==conversion_result)){
        ...
        if(0x01 == _adc->result_format){
            *conversion_result = (adc_result)((ADRESH<< 8 )+ ADRESL );
        }
        else if(0x00 == _adc->result_format){
...
static __attribute__((inline)) void adc_configure_voltage_refernce(const adc_conf_t *_adc){
    if(0x01 == _adc->voltage_refernce){
        do{ADCON1bits.VCFG1=1; ADCON1bits.VCFG0=1; }while(0);
    }
    else if(0x00== _adc->voltage_refernce){
